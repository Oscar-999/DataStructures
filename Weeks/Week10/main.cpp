...
int main() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2: cout << "Delete disabled for this assignment.\n"; break;
...
void addVehicle() {
    ...
    vehicleTree.addNode(newVehicle);
...
void searchForVehicle() {
    ...
    Vehicle* found = vehicleTree.search(vin);
    if (found) {
...
void readData() {
    ...
    while (getline(file, line)) {
        ...
        vehicleTree.addNode(vehiclePtr); //Add to Bst
    }
